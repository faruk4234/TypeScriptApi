...
export default class AddingValidator {
  ...
  public schema = schema.create({
    ...
    kinds: schema.array([rules.minLength(0), rules.maxLength(10)]).members(schema.number()),
    actors: schema.array([rules.minLength(0), rules.maxLength(10)]).members(schema.number()),
  })
